...
<title>GuitarWorld | Electric</title>
...
<div id="container">
  ...
  <main>
  <div id="content1_electric">
    <h1>Electric</h1>
  </div>
  <div id="content2_electric">
    <table class="guitars">
      <?php
		$sql = "SELECT id, small_image, large_image, brand, description, price FROM guitars WHERE id <= 3;";
